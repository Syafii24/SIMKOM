...
$count_query = mysql_query("SELECT COUNT(idpegawai)
...
<thead>
<tr>
	<td colspan="9"><a href="?page=pegawai&act=tambahpegawai">
	<img src="icon/ButtonAddicon32.png" width="24" height="24" border="0" align="absmiddle" title="Tambah Data pegawai"></a>
	<b>TAMBAH PEGAWAI</b>
	</td>
</tr>
<tr>
	<th><div align="center">NO</div></th>
    <th><div align="center">ID PEGAWAI</div></th>
	...
	<th><div align="center">TANGGAL MASUK</div></th>
...
if (empty ($A)){
	...
	idpegawai asc LIMIT $offset,$per_hal");
}else{
	$qry=mysql_query("select * from $tblname where 
	idpegawai like '%$A%'|| nmpegawai like '%$A%'
	order by idpegawai asc LIMIT $offset,$per_hal");
}
...
while($r=mysql_fetch_array($qry)){
	$no=$no+1;
	$Tgl=date("d/m/Y",strtotime($r[tglmasuk]));
	echo"
	<tr>
		<td><div align='center'>$no</div></td>
		<td><div align='center'>$r[idpegawai]</div></td>
		<td><div align='center'>$r[nmpegawai]</div></td>
		<td><div align='center'>$r[jkel]</div></td>
		<td><div align='center'>$r[alpegawai]</div></td>
		<td><div align='center'>$r[email]</div></td>
		<td><div align='center'>$r[no_kontak]</div></td>
		<td><div align='center'>$Tgl</div></td>
		<td><div align='center'>
		<a href='?page=pegawai&act=editpegawai&id=
		$r[idpegawai]' title='Edit Data'>
		<img src='icon/editicon32.png' align='absmiddle'
		width='20' height='20'></a> |
		<a href='$aksi?page=pegawai&act=hapus&id=
		$r[idpegawai]' title='Hapus Data'>
...
?>
<!-- Awal Form Tambah -->
<h2>TAMBAH PEGAWAI</h2><hr>
<form action="modul/pegawai/aksi_pegawai.php?page=pegawai&act=input" method="post" autocomplete="on" />
<?php
//Ketikkan Source Code 8 Disini 
$id_pegawai= _kd_auto('idpegawai','pegawai','P-');
//Batas Akhir Pengetikkan Source Code 8
?>
<table border="0" align="center" width="80%">
<thead>
	<tr>
		<th colspan="2"><div align="center"><H2>FORM TAMBAH PEGAWAI</H2></div></th>
	</tr>
</thead>
<tbody>
<!-- Ketikkan Source Code 9 Disini -->
<tr> 
	<td><h3><b>ID PEGAWAI</b></h3></td>
	<td><input class="style35" name="T1" id="T1" type="text"
	value="<?php echo $id_pegawai; ?>" readonly />
<small>Contoh : P-000001, dll</small></td>
</tr>
<tr>
	<td><h3><b>NAMA PEGAWAI</b></h3></td>
	<td><input class="style35" name="T2" id="T2" type="text"
	placeholder="Isi Nama pegawai ..." required />
	<small>Contoh : pegawai 1, dll</small></td>
</tr>
<tr>	
	<td><h3><b>JENIS KELAMIN</b></h3></td>
	<td><select class="style35" id="T3" name="T3" required>
...
<tr>
	...
	<td><input class="style35" name="T5" id="T5" type="text"
	placeholder="Isi Email anda..." required />
	<small>Contoh : pegawai 1, dll</small></td>
</tr>
<tr>
	<td><h3><b>NO KONTAK</b></h3></td>
	<td><input class="style35" name="T6" id="T6" type="text"
	placeholder="Isi no hp/tlp ..." required />
	<small>Contoh : 081456xxxxxx,</small></td>
</tr>
<tr>
	<td><h3><b>TANGGAL MASUK</b></h3></td>
	<td><input class="style35" type="text" name="T7" id="T7" 
...
case "editpegawai":
$edit = mysql_query("SELECT * FROM pegawai WHERE idpegawai='$_GET[id]'");
$r	= mysql_fetch_array($edit);

//Batas Akhir Pengetikkan Source Code 11	
?>
<!-- Awal Form Edit -->
<h2>UBAH PEGAWAI</h2><hr>
<form action="modul/pegawai/aksi_pegawai.php?page=pegawai&act=update" method="post" />
<table border="0" align="center" width="80%">
<thead>
<tr>
	<th colspan="2"><div align="center"><H3>FORM UPDATE PEGAWAI</H3></div></th>
</tr>
</thead>
<tbody>
...
<tr> 
	<td><h3><b>ID PEGAWAI</b></h3></td>
	<td><input class="style35" name="T1" id="T1" type="text"
	value="<?php echo "$r[idpegawai]"; ?>" readonly />
	<small>Contoh : B-0000001, dll</small></td>
</tr>
<tr> 
	<td><h3><b>NAMA PEGAWAI</b></h3></td>
	<td><input class="style35" name="T2" id="T2" type="text"
	value="<?php echo "$r[nmpegawai]"; ?>" />
	<small>Contoh : PEGAWAI 1, dll</small></td>
</tr>
<tr>	
	<td><h3><b>JENIS KELAMIN</b></h3></td>
...
<tr>
	<td><h3><b>ALAMAT</b></h3></td>
	<td><textarea class="style35" name="T4" id="T4" type="text"
	value="<?php echo "$r[alpegawai]"; ?>" required />
 </textarea>
</tr>
<tr>
	<td><h3><b>EMAIL</b></h3></td>
	...
	<small>Contoh : pegawai@gmail.com, dll</small></td>
</tr>
<tr>
	<td><h3><b>NO KONTAK</b></h3></td>
	<td><input class="style35" name="T6" id="T6" type="text"
	value="<?php echo "$r[no_kontak]"; ?>" required />
	<small>Contoh : 081456xxxxxx,</small></td>
</tr>
<tr>
	<td><h3><b>TANGGAL MASUK</b></h3></td>
	<td><input class="style35" type="text" name="T7" id="T7" 
	value="<?php echo"$r[tglmasuk]"; ?>" />
	<img type="image" src="images/calPick.gif" name="CALTGL1"
	width="20" height="20" align="absmiddle" id="CALTGL1"
	style="cursor:pointer;cursor:hand;" />
	<script type="text/javascript">
