...
$aksi="modul/konsumen/aksi_konsumen.php";
switch($_GET[act]){
...
$reload="?page=konsumen";
//cari berapa banyak jumlah data*/
$count_query = mysql_query("SELECT COUNT(idkonsumen)
...
<thead>
<tr>
	<td colspan="7"><a href="?page=konsumen&act=tambahkonsumen">
	<img src="icon/ButtonAddicon32.png" width="24" height="24" border="0" align="absmiddle" title="Tambah Data bagian"></a>
	<b>TAMBAH KONSUMEN</b>
	</td>
</tr>
<tr>
	<th><div align="center">NO</div></th>
    <th><div align="center">ID KONSUMEN</div></th>
	<th><div align="center">NAMA KONSUMEN</div></th>
	<th><div align="center">ALAMAT</div></th>
	<th><div align="center">EMAIL</div></th>
	<th><div align="center">TGL DAFTAR</div></th>
...
if (empty ($A)){
	...
	idkonsumen asc LIMIT $offset,$per_hal");
}else{
	$qry=mysql_query("select * from $tblname where 
	idkonsumen like '%$A%'|| nmkonsumen like '%$A%'
	order by idkonsumen asc LIMIT $offset,$per_hal");
}
...
while($r=mysql_fetch_array($qry)){
	...
	<tr>
		...
		<td><div align='center'>$r[idkonsumen]</div></td>
		<td><div align='center'>$r[nmkonsumen]</div></td>
		<td><div align='center'>$r[alkonsumen]</div></td>
		<td><div align='center'>$r[email]</div></td>
		<td><div align='center'>$Tgl</div></td>
		<td><div align='center'>
		<a href='?page=konsumen&act=editkonsumen&id=
		$r[idkonsumen]' title='Edit Data'>
		<img src='icon/editicon32.png' align='absmiddle'
		width='20' height='20'></a> |
		<a href='$aksi?page=konsumen&act=hapus&id=
		$r[idkonsumen]' title='Hapus Data'>
...
?>
<!-- Awal Form Tambah -->
<h2>TAMBAH KONSUMEN</h2><hr>
<form action="modul/konsumen/aksi_konsumen.php?page=konsumen&act=input" method="post" autocomplete="on" />
<?php
//Ketikkan Source Code 8 Disini 
$id_konsumen= _kd_auto('idkonsumen','konsumen','K-');
//Batas Akhir Pengetikkan Source Code 8
?>
<table border="0" align="center" width="80%">
<thead>
	<tr>
		<th colspan="2"><div align="center"><H2>FORM TAMBAH KONSUMEN</H2></div></th>
	</tr>
</thead>
<tbody>
<!-- Ketikkan Source Code 9 Disini -->
<tr> 
	<td><h3><b>ID KONSUMEN</b></h3></td>
	<td><input class="style35" name="T1" id="T1" type="text"
	value="<?php echo $id_konsumen; ?>" readonly />
...
<tr>
	<td><h3><b>ALAMAT KONSUMEN</b></h3></td>
	<td><textarea class="style35" name="T3" id="T3" type="text"
	placeholder="Isi Alamat Kamu ..." required /></textarea>
</tr>
<tr>
...
case "editkonsumen":
$edit = mysql_query("SELECT * FROM konsumen WHERE idkonsumen='$_GET[id]'");
$r	= mysql_fetch_array($edit);

//Batas Akhir Pengetikkan Source Code 11	
?>
<!-- Awal Form Edit -->
<h2>UBAH DATA KONSUMEN</h2><hr>
<form action="modul/konsumen/aksi_konsumen.php?page=konsumen&act=update" method="post" />
<table border="0" align="center" width="80%">
<thead>
<tr>
	<th colspan="2"><div align="center"><H3>FORM UPDATE KONSUMEN</H3></div></th>
</tr>
</thead>
<tbody>
...
<tr> 
	<td><h3><b>ID KONSUMEN</b></h3></td>
	<td><input class="style35" name="T1" id="T1" type="text"
	value="<?php echo "$r[idkonsumen]"; ?>" readonly />
	<small>Contoh : K-0000001, dll</small></td>
</tr>
<tr> 
	<td><h3><b>NAMA KONSUMEN</b></h3></td>
	<td><input class="style35" name="T2" id="T2" type="text"
	value="<?php echo "$r[nmkonsumen]"; ?>" />
</tr>
<tr>
	<td><h3><b>ALAMAT KONSUMEN</b></h3></td>
	<td><textarea class="style35" name="T3" id="T3" type="text"
